...
namespace ECommerce.Server.Migrations
{
    ...
    [Migration("20250405214144_InitialMigration")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ECommerce.Shared.Models.Product.Category", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ECommerce.Shared.Models.Product.Product", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ECommerce.Shared.Models.Product.ProductType", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ECommerce.Shared.Models.Product.ProductVariant", b =>
                {
            ...
            modelBuilder.Entity("ECommerce.Shared.Models.User.User", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            IsAdmin = false,
                            Name = "Frodo",
                            PasswordHash = "$2a$11$wSWrS72E7Yso99DjiojnP.Ef0oMU1r0pJPZ6fgYdXl3I9arTIj1u6"
                        },
                        new
                        {
                            Id = 2,
                            ...
                            IsAdmin = true,
                            Name = "Gandalf",
                            PasswordHash = "$2a$11$k.tAwyyw.eqQ0BojHXQGE.uU0QIFnlYUvwjEWvx8PIhvUkJRMxl7G"
                        });
                });

            modelBuilder.Entity("ECommerce.Shared.Models.Product.Product", b =>
                {
                    b.HasOne("ECommerce.Shared.Models.Product.Category", "Category")
                        .WithMany()
            ...
            modelBuilder.Entity("ECommerce.Shared.Models.Product.ProductVariant", b =>
                {
                    b.HasOne("ECommerce.Shared.Models.Product.Product", "Product")
                        .WithMany("Variants")
                        .HasForeignKey("ProductId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("ECommerce.Shared.Models.Product.ProductType", "ProductType")
                        .WithMany()
